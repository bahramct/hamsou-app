...
- [ ] اشتراک‌گذاری تعهدات تکمیل شده
- [ ] اشتراک‌گذاری Streak
- [ ] تولید تصویر برای سوشال مدیا
- [ ] دکمه‌های اشتراک‌گذاری (Twitter, LinkedIn, etc.)
...
- [ ] GET/PUT /api/profile - مدیریت پروفایل
- [ ] POST /api/share - اشتراک‌گذاری دستاورد
...
| 7 | قابلیت‌های اجتماعی | ⏳ شروع نشده | 0% |
...
**پیشرفت کلی پروژه:** **~54%** (5.75 فاز از 12 فاز اصلی)
