...
- [x] آمار تعهدات هفتگی
- [x] پیاده‌سازی کانسپت همسو (Hamsu):
  - [x] یک تعهد در هر روز
  - [x] بازتاب فقط در روز بعد (نه همان روز)
  - [x] سیستم مبتنی بر تقویم (نه رفتار کاربر)
  - [x] تاریخچه فقط تعهدات با بازتاب تکمیل شده
...
- [x] خروجی PDF از گزارش ماهانه
- [x] خروجی Excel از داده‌ها
- [x] قالب‌های آماده گزارش
- [x] اشتراک‌گذاری گزارش‌ها
...
**وضعیت: 🔄 90% تکمیل شده (7.1, 7.2, 7.3 - 7.4 اختیاری)**
...
- [x] تحلیل برنامه‌های قبلی (8.2.1)
- [x] پیشنهاد تعهدات مناسب (8.2.2)
- [x] تنظیم خودکار بر اساس ظرفیت (8.2.3)
- [x] یادگیری از رفتار کاربر (8.2.4)
- [x] بهینه‌سازی زمان‌بندی (8.2.5)
- [x] اعتبارسنجی حداقل داده‌ها (۷ روز)
- [x] فیلتر تاریخچه برای پیشنهاد هوشمند
- [x] اصلاح تولید داده‌های تستی (فقط روزهای گذشته)
...
- [x] POST /api/ai/suggest-commitments - پیشنهاد تعهد
