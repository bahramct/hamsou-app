...
| ۴ | Onboarding Flow | فیچر جدید ✨ | 🟠 High | ✅ تمام | multi-auth ✅ | — | DECISION-086 — سفرِ رواییِ تمام‌صفحه (۴ پرده، شخصی‌سازیِ هویت، هدایت به اولین تعهد) + روتینگِ کاربرِ نو (OTP/ایمیل) + ۳ رفعِ ایراد (مودالِ فریز Portal، {{USER}} در همدم) — ۲۰۲۶-۰۶-۱۴ |
