      ...
      <div className="max-w-7xl mx-auto">
        <div className="hero-grid grid grid-cols-1 lg:grid-cols-[1.3fr_1fr] gap-16 items-center" style={{ gridTemplateColumns: "1.3fr 1fr" }}>
          <div>
            ...
            <h1 className="anim-fade-up d-2" style={{ fontWeight: 100, fontSize: c.fontSize("title"), lineHeight: 1.05, letterSpacing: "-0.025em", color: "var(--color-ink)" }}>
            ...
            <p className="anim-fade-up d-3 mt-8 max-w-xl text-stone" style={{ fontWeight: 300, fontSize: c.fontSize("para"), lineHeight: 1.75 }}>
              {c.text("paraA")}{" "}
...
const landingHero: SectionDef = {
  ...
  fields: [
    ...
    { key: "t1a", label: "عنوان خط۱ — قبل", type: "text", defaultFontSize: "clamp(40px, 6.5vw, 92px)" },
    ...
    { key: "paraA", label: "توضیح", type: "textarea", defaultFontSize: "19px" },
  ...
  defaultStyles: { title: { fontSize: "clamp(40px, 6.5vw, 92px)" }, para: { fontSize: "19px" } },
  ...
  return (
    <section className="relative z-10 px-6 lg:px-10 py-24 lg:py-32">
      <div className="max-w-4xl mx-auto text-center reveal">
        ...
        <p className="mt-8 text-stone" style={{ fontWeight: 300, fontSize: "15px" }}>{c.text("attribution")}</p>
      </div>
    </section>
  );
}
const landingManifesto: SectionDef = {
  ...
  fields: [
    ...
    { key: "quoteA", label: "نقل‌قول — قبل", type: "textarea", defaultFontSize: "clamp(28px, 4.5vw, 52px)" },
  ...
  defaultStyles: { quote: { fontSize: "clamp(28px, 4.5vw, 52px)" } },
...
const landingProblem: SectionDef = {
  ...
  fields: [
    ...
    { key: "headingA", label: "عنوان — خط اول", type: "text", defaultFontSize: "clamp(30px, 4vw, 46px)" },
  ...
  defaultStyles: { heading: { fontSize: "clamp(30px, 4vw, 46px)" } },
    ...
    <section id="solution" className="relative z-10 px-6 lg:px-10 py-24 lg:py-32">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          {cards.map((card, i) => (
            <div key={card.t} className="glass rounded-3xl p-8 hover-rise reveal" style={i > 0 ? { transitionDelay: `${i * 60}ms` } : undefined}>
              <div className="flex items-center justify-between mb-8">
                <div className="step-num fa-num">{["۱", "۲", "۳"][i]}</div>
                <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" style={{ color: "var(--color-fog)" }}>{card.icon}</svg>
              </div>
              <h3 style={{ fontWeight: 400, fontSize: "24px", letterSpacing: "-0.005em" }}>{c.text(card.t)}</h3>
...
const landingSolution: SectionDef = {
  ...
  fields: [
    { key: "eyebrow", label: "برچسب", type: "text" },
    { key: "headingA", label: "عنوان — بخش اول", type: "text", defaultFontSize: "clamp(30px, 4.2vw, 50px)" },
  ...
  defaultStyles: { heading: { fontSize: "clamp(30px, 4.2vw, 50px)" } },
    ...
    <section id="testimonial" className="relative z-10 px-6 lg:px-10 py-24 lg:py-32">
      <div className="max-w-3xl mx-auto text-center reveal">
        ...
        <div className="mt-10 flex items-center justify-center gap-4">
          <div className="w-12 h-12 rounded-full flex items-center justify-center" style={{ background: "var(--color-bone)", color: "var(--color-sage-deep)", fontWeight: 300, fontSize: "18px" }}>{c.text("avatarLetter")}</div>
...
const landingTestimonial: SectionDef = {
  ...
  fields: [
    { key: "eyebrow", label: "برچسب", type: "text" },
    { key: "quote", label: "نقل‌قول", type: "textarea", defaultFontSize: "clamp(22px, 3.2vw, 34px)" },
  ...
  defaultStyles: { quote: { fontSize: "clamp(22px, 3.2vw, 34px)" } },
...
const landingFinalCta: SectionDef = {
  ...
  fields: [
    { key: "headingA", label: "عنوان — خط اول", type: "text", defaultFontSize: "clamp(34px, 5.5vw, 64px)" },
  ...
  defaultStyles: { heading: { fontSize: "clamp(34px, 5.5vw, 64px)" } },
